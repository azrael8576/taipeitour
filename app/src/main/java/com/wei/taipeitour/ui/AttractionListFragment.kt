...
import com.wei.taipeitour.GlideApp
import com.wei.taipeitour.R
import com.wei.taipeitour.adapter.AttractionAdapter
import com.wei.taipeitour.adapter.AttractionLoadStateAdapter
import com.wei.taipeitour.ServiceLocator
import com.wei.taipeitour.databinding.FragmentAttractionListBinding
import com.wei.taipeitour.paging.asMergedLoadStates
import com.wei.taipeitour.repository.AttractionRepository
import com.wei.taipeitour.utilities.InjectorUtils
import com.wei.taipeitour.viewmodels.AttractionViewModel
...
class AttractionListFragment : Fragment(), OnClickAttractionListener {
    ...
    private fun initToolbar(binding: FragmentAttractionListBinding) {
        ...
        binding.toolbar.setTitleTextColor(resources.getColor(R.color.taipeitour_gray_50_a600))
        binding.toolbarTranslateButton.setColorFilter(resources.getColor(R.color.taipeitour_gray_50_a600))
